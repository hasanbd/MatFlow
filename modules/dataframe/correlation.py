...
def correlation(data):
    st.markdown("<h5 style='text-align: center; color: black;'>🔅Representation of Feature Correlation🔅</h5>",
...
def display_heatmap(correlation_data):
    ...
    ax = sns.heatmap(correlation_data.round(2), fmt=f".{int(decimal)}f")
