...
def imputation(data, data_opt):
	...
	if null_var != []:
		...
		col2.markdown("#")
		add_pipeline = col2.checkbox("Update to Storage", True, key="impute_add_pipeline")
		...
		st.markdown("<h5 style='text-align: left; color: black;'>❗No Column Consist Missing Values</h5>",
