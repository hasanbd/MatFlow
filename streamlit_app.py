...
menu_data = [
    {'id': 'Home', 'label': "🖼MatFlow"},
    {'id': 'Contact', 'label': "📱Contact"},
    {'id': 'Help', 'label': "📇Help"},
]

over_theme = {'txc_inactive': 'white','menu_background':'purple','txc_active':'yellow','option_active':'green'}
menu_id = hc.nav_bar(
...
#menu_id = hc.nav_bar(
#    menu_definition=menu_data,
#    override_theme={'bgcolor': 'green', 'title_color': 'green', 'content_color': 'green', 'icon_color': 'green',
